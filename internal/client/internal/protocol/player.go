...
// 本文件是玩家档案量的共用模型：体力、等级。它们跨域出现的次数在 ref 折叠面里排第 3–4
...
// LevelInfo 是一次结算带来的等级变化。ref 只折叠其中两处：Team.StartLevel 更新主公等级，
...
//
// 与 RewardCarrier 同构，理由也相同：ref 里有 17 个响应回传体力，各自字段名还不一样
