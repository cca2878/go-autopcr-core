...
func foldLoadIndex(s *PlayerState, _ protocol.Request, resp any) {
	...
	if lr.UserJewel != nil {
		s.Jewel = Currency{Free: int64(lr.UserJewel.FreeJewel), Paid: int64(lr.UserJewel.Jewel)}
	}
	if lr.UserGold != nil {
		s.Gold = Currency{Free: lr.UserGold.GoldIDFree, Paid: lr.UserGold.GoldIDPay}
	}
	if lr.UserClan != nil {
...
func foldHomeIndex(s *PlayerState, _ protocol.Request, resp any) {
